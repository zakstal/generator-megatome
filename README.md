...
## In-progress Notes
** layed down a code dump for bower-registry generator, bower-component generator & updated app to have a living style guide living on the developer deploys. Nothing works. Need to lay down a page generator as well. **
