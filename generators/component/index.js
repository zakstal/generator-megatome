...
module.exports = yeoman.generators.Base.extend({
  prompting: function () {
    ...
    var prompts = [{
      ...
      type: 'input',
      name: 'bower',
      message: 'Where is your private bower repo?',
  ...
  writing: {
    ...
    projectfiles: function () {
      ...
      cp('_main.js','src/'+this.ComponentName+'.js');
      cp('_main.sass','src/'+this.ComponentName+'.sass');
      cp('_index.html','dev/index.html');
    }
  },
  ...
  install: function () {
    ...
    this.log('Now run `npm run up` to start the devlopment server.');
  }
});
